...
BaseNode(List<T, Allocator>::BaseNode&& other)
...
template <typename T, class Allocator>
List<T, Allocator>::Node::Node(List<T, Allocator>::BaseNode* prev, List<T, Allocator>::BaseNode* next, int hash)
...
template <typename T, class Allocator>
template <typename U>
List<T, Allocator>::iterator_<U>::iterator_(BaseNode* node)
    : cur_node_(node) {}
